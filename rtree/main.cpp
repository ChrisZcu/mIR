...
int main(const int argc, const char** argv)
{
	...
	// print 100-skyband products
	cout <<"compute kskyband and store it!"<<endl;
	kskyband(dim, *rtree, skyband, PointSet, 100);
	char filename[100];
	sprintf(filename, "house_skyband5d.txt");
	printSkyBand(PointSet,skyband,dim,filename);
